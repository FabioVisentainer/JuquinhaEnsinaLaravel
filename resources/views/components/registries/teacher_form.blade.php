...
<div class="text-black text-xl bg-red-100 font-londrina p-2 border-red-200 rounded-lg">
    ...
    @else
        ...
        <input type="text" name="username" if="username" value="{{ old('username') }}" placeholder="usuario" readonly required autocomplete="off" class="inputBox bg-zinc-100 dark:bg-slate-100 hidden">
    @endif
    ...
    <input name="country_id" id="country_id" value="{{ $teacher->address->country->name ?? '' }}" class="inputBox bg-gray-300 border-gray-300" disabled="disabled"> <!-- nao tenho assento no teclado :( -->
