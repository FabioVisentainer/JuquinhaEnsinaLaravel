  ...
  <body class="body bg-slate-50">
      ...
      <main>
          <div class="total relative top-1 transition-all duration-300 ease-in-out">
              <div>
                  <h1 class="pageTitle">Videos Educativos!</h1>
              </div>
              ...
              <div class="container mx-auto p-4 py-8">
                  ...
                  <div id="videoList" class="dadCards">
                      @foreach($videos as $video)
                          <div class="card bg-[#B9CAEF] drop-shadow-2xl dark:drop-shadow-[0_0px_30px_rgba(0, 102, 204, 0.5)] p-3 w-[500px] h-[400px] p-4">
