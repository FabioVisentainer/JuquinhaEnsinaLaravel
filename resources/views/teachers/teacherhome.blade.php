    ...
    <div class="total relative top-1 transition-all duration-300 ease-in-out">
      ...
      <div class="dadCards">
        <div class="card bg-[#FFEEB1] drop-shadow-2xl dark:drop-shadow-[0_0px_30px_rgba(255,232,150,0.5)]">
          <a href="{{ route('teachers.activity.home') }}"><img class="p-8" src="../images/atividades.png" alt="Responsaveis" width="350px"><p class="text-4xl p-2 sm:text-4xl">Liberar Atividades</p></a>
        </div>

        <div class="card bg-[#C5B9EF] drop-shadow-2xl dark:drop-shadow-[0_0px_30px_rgba(148,119,252,0.5)]">
          <a href="{{ route('teachers.homework.home') }}"><img class="p-8" src="../images/tarefas.png" alt="Responsaveis" width="350px"><p class="text-4xl p-2 sm:text-4xl">Liberar Tarefas</p></a>
        </div>

        <div class="card bg-[#BEF1EE] drop-shadow-2xl dark:drop-shadow-[0_0px_30px_rgba(176,255,250,0.5)]">
          <a href="{{ route('teachers.frequency.home') }}"><img class="p-8" src="../images/frequencia.png" alt="Responsaveis" width="350px"><p class="text-4xl p-2 sm:text-4xl">Registrar Frequência</p></a>
        </div>

        <div class="card bg-[#FFB1B2] drop-shadow-2xl dark:drop-shadow-[0_0px_30px_rgba(255, 0, 0)]">
          <a href="{{ route('teachers.grades.home') }}"><img class="p-8" src="../images/boletim.png" alt="Responsaveis" width="350px"><p class="text-4xl p-2 sm:text-4xl">Registrar Boletim</p></a>
        </div>

        <div class="card bg-[#B9CAEF] drop-shadow-2xl dark:drop-shadow-[0_0px_30px_rgba(0, 102, 204, 0.5)]">
          <a href="{{ route('teachers.videos.home') }}"><img class="p-8" src="../images/videos(blue).png" alt="Responsaveis" width="350px"><p class="text-4xl p-2 sm:text-4xl">Enviar Videos</p></a>
        </div>
