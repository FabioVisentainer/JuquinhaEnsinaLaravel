          ...
          $.ajax({
            ...
            success: function(data) {
              ...
              data.class.forEach(cls => {
                // Calcular a porcentagem de presença da classe
                const totalAttendance = cls.total_count; // Total de atendimentos da classe
                const presentCount = cls.present_count; // Contagem de presentes na classe
                ...
                // Encontrar os alunos desta classe
