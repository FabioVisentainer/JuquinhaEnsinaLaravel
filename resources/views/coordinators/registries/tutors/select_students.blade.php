      ...
      <nav class="flex justify-between items-center">
          <div class="p-5 md:flex md:justify-between max-[770px]:hidden">
              <div class="max-[770px]:hidden">
                  ...
                  <a href="{{ route('coordinators.registries.tutors.edit', $tutor->tutor_id) }}">
                                  ...
                                  @foreach($students as $student)
                                      <div class="bg-white p-4 rounded-lg shadow flex items-center justify-between dark:bg-gray-700 w-full">
                                          <div class="flex flex-col">
                                              ...
                                              <p class="text-gray-600 text-lg dark:text-gray-300"><span class="font-bold">Gênero:</span> {{ $student->student_gender }}</p>
                                              <p class="text-gray-600 dark:text-gray-300"><span class="font-bold">Data de Cadastro:</span> {{ $student->student_registry_date }}</p>
                                          </div>
