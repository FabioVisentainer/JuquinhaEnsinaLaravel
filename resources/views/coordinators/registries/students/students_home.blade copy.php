<x-layout>
    <body class="body bg-slate-50">
        ...
        <div class="total relative top-1 transition-all duration-300 ease-in-out">
            ...
            @if($students->isEmpty())
                <h1 class="pageTitle text-2xl md:text-3xl">Não há estudantes cadastrados na sua entidade</h1>
            @else
                <div class="container mx-auto p-4 py-8">
                    ...
                    <div class="flex justify-center items-center">
                        <button class="blueButton rounded-xl sm:w-[50%] md:w-[35%] lg:w-[20%] ">
                            <a href="{{ route('coordinators.registries.students.new') }}">Cadastrar novo aluno</a>
                        </button>
                    </div>
                        ...
                        @foreach($students as $student)
                            <div class="bg-white p-4 rounded-lg shadow flex justify-between items-center dark:bg-gray-700">
                                <div class="flex flex-col">
                                    ...
                                    <p class="mt-1 ml-0.5 text-gray-600 text-xl dark:text-gray-300"><span class="font-bold">Status:</span> {{ $student->is_active ? 'Ativo' : 'Inativo' }}</p>
                                    ...
                                    <p class="mt-1 ml-0.5 text-gray-600 text-xl dark:text-gray-300"><span class="font-bold">Gênero:</span> {{ $student->student_gender }}</p>
                                    ...
                                    <a href="{{ route('coordinators.registries.students.edit', $student->student_id) }}">
                                        <button class="mt-4 w-36 flex items-center justify-center bg-blue-500 text-white rounded-xl hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 py-3 mb-3">Editar</button>
                                    </a> 
                                </div>
