            ...
            <div class="total relative top-1 transition-all duration-300 ease-in-out">
                ...
                <form action="{{ route('coordinators.save_class', $student->student_id) }}" method="POST" class="form">
                    ...
                    <div class="flex justify-center">
                      <a href="{{ route('coordinators.registries.students.edit', $student->student_id) }}"><input type="submit" value="Enviar" class="blueButton rounded-xl px-8 py-3 w-full text-lg"></a> 
                    </div>
                </form>
            </div>
          </div>
