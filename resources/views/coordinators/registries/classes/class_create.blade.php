<x-layout>
  <body class="body bg-slate-50">
      ...
      <div class="total relative top-1 transition-all duration-300 ease-in-out">
          <h1 class="pageTitle text-4xl md:text-6xl">Cadastrar Nova Turma</h1>

          <div class="contCenter flex justify-center">
              <form action="{{ route('coordinators.registries.classes.store') }}" method="POST" class="form">
                  @csrf

                  <x-registries.class_form />

                  <div class="flex justify-center mt-4">
                      <input type="submit" value="Registrar Turma" class="blueButton rounded-full px-8 py-3 text-lg">
                  </div>
              </form>
          </div>
      </div>
