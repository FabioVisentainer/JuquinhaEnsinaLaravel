    ...
    <body class="body bg-slate-50">
      <nav class="flex justify-between items-center">
        ...
        <div>
          ...
          <img class="x invertColor cursor-pointer hidden transition-all ease-linear duration-500 md:hidden max-[800px]:ml-3" src="{{ asset('images/x.png') }}" alt="Fechar menu hamburger" width="30px">
        </div>
