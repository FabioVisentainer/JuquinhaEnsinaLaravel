      ...
      <div class="flex gap-8 p-5">
        ...
        <div>
          <a href="{{ route('coordinators.notifications.home') }}">
            <img id="notificationIcon" class="invertColor cursor-pointer" src="{{ asset('images/notificacao.png') }}" alt="Botao de notificações" width="40px">
          </a>
        </div>
      ...
      <div class="dadCards">
        <div class="card bg-[#FFEEB1] drop-shadow-2xl dark:drop-shadow-[0_0px_30px_rgba(255,232,150,0.5)]">
          <a href="{{ route('coordinators.registries.students.home') }}">
            <img class="p-8" src="{{ asset('images/RegisAluno.png') }}" alt="Cadastros de Alunos" width="350px">
        ...
        <div class="card bg-[#FFEEB1] drop-shadow-2xl dark:drop-shadow-[0_0px_30px_rgba(255,232,150,0.5)]">
          <a href="{{ route('coordinators.registries.tutors.home') }}">
            <img class="p-8" src="{{ asset('images/RegisResponsaveis.png') }}" alt="Cadastros de Responsáveis" width="350px">
            <p class="text-2xl p-2 sm:text-3xl">Cadastros de Responsáveis</p>
          </a>
        </div>

        <div class="card bg-[#FFEEB1] drop-shadow-2xl dark:drop-shadow-[0_0px_30px_rgba(255,232,150,0.5)]">
          <a href="{{ route('coordinators.registries.teachers.home') }}">
            <img class="p-8" src="{{ asset('images/RegisProfessor.png') }}" alt="Cadastros de Docentes" width="350px">
