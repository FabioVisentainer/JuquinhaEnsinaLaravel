    ...
    <body class="body bg-slate-50">
        ...
        <div class="p-5 md:flex md:justify-between max-[770px]:hidden">
          <div class="max-[770px]:hidden">
            ...
            <a href="{{ route('coordinators.registries.teachers.home') }}"><img class="invertColor cursor-pointer pointer-events-auto" src="{{ asset('images/voltar.png') }}" alt="Botao de voltar a pagina" width="40px"></a>
          </div>
        </div>
        ...
        <main>
            ...
            <div>
                <h1 class="pageTitle text-4xl md:text-6xl">Editar Professor</h1>
              </div>
                <div class="contCenter">
                    <img src="{{ asset('images/perfil.png') }}" alt="Imagem do Perfil" width="250px" class="invertColor">

                    <form action="{{ route('coordinators.registries.teachers.update', $teacher->teacher_id) }}" method="POST" class="form">
                        @csrf
                        ...
                        <input type="submit" value="Atualizar Professor" class="blueButton rounded-full sm:w-[90%] md:w-[75%] lg:w-[70%]">
                    </form>
                </div>
            </div>
