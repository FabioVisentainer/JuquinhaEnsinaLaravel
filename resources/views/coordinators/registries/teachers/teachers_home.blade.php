...
@if($teachers->isEmpty())
    <h1 class="pageTitle text-2xl md:text-3xl">Nao tem Professores cadastrados na sua entidade</h1>
@else
    ...
    <div class="flex justify-center items-center">
        <button class="blueButton rounded-xl sm:w-[50%] md:w-[35%] lg:w-[30%] "><a href="{{ route('coordinators.registries.teachers.new') }}">Cadastrar novo Docente</a>
        </button>
      </div>
    ...
    <div id = "teacherList"class="grid gap-4 p-4 bg-gray-200 rounded-lg w-full dark:bg-gray-800 mt-6">
        ...
        <div class="teacher bg-white p-4 rounded-lg shadow flex justify-between items-center dark:bg-gray-700">
            <div class="flex flex-col">
                ...
                <p class="mt-1 ml-0.5 text-gray-600 text-xl dark:text-gray-300"><span class="font-bold">Status:</span> {{ $teacher->is_active ? 'Active' : 'Inactive' }}</p>
