...
<body class="body bg-slate-50">
    ...
    <main>
        ...
        <div>
            <h1 class="pageTitle text-4xl md:text-6xl">Registrar novo Professor</h1>
          </div>
            <div class="contCenter">
                <img src="{{ asset('images/perfil.png') }}" alt="Imagem do Perfil" width="250px" class="invertColor">
                
    <form action="{{ route('coordinators.registries.teachers.store') }}" method="POST" class="form">
        @csrf
        <x-registries.teacher_form />
        <button type="submit" class="blueButton rounded-full sm:w-[90%] md:w-[75%] lg:w-[70%]">Registrar Professor</button>
    </form>
</div>
</div>
    <x-errors />
