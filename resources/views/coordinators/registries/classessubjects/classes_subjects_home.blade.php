              ...
              {{-- <div class="container mx-auto p-4 py-8 mt-6">
                  <div class="grid gap-4 bg-gray-200 rounded-lg w-full dark:bg-gray-800 p-4">
                      <table class="w-full text-left">
                          <thead>
                              <tr class="bg-gray-300 dark:bg-gray-900 text-gray-800 dark:text-gray-300">
                                  <th class="p-3 text-xl">Nome</th>
                                  <th class="p-3 text-xl">Data de Criação</th>
                                  <th class="p-3 text-xl">Ativo?</th>
                                  <th class="p-3 text-xl">Ações</th>
                              </tr>
                          </thead>
                          <tbody>
                              @foreach($classessubjects as $classsubject)
                                  <tr class="bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-200 border-b border-gray-200 dark:border-gray-600">
                                      <td class="p-3">{{ $classsubject->class_subject_name }}</td>
                                      <td class="p-3">{{ $classsubject->created_at }}</td>
                                      <td class="p-3">{{ $classsubject->is_active ? 'Sim' : 'Não' }}</td>
                                      <td class="p-3">
