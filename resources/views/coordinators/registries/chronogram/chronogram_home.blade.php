            ...
            @foreach($chronograms as $chronogram)
              <div class="class bg-white p-4 rounded-lg shadow flex flex-col md:flex-row md:justify-between items-start md:items-center dark:bg-gray-700">
                <div class="flex flex-col">
                  ...
                  <p class="mt-1 text-gray-600 text-xl dark:text-white"><span class="font-bold">Ativo?</span> {{ $chronogram->is_active ? 'Sim' : 'Não' }}</p>
                  <p class="mt-1 text-gray-600 text-xl dark:text-white"><span class="font-bold">Data de Criação:</span> {{ $chronogram->created_at }}</p>
                </div>
